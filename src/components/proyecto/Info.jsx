          ...
          { integrantes.map((item, index) =>
            {
              ...
              return (<div className="proy-colaborator" style={{display: 'flex', margin: '10px'}} key={index}>
                <img src={(item.avatar_pat && item.avatar_pat !== '/assets/img/placeholder.png') ? `/quantumapi${item.avatar_pat}` : '/assets/img/placeholder.png'}  className={'img-responsive img-circle'} alt={'Icono'} style={{margin: 0, height: '30px', width:'30px'}} />
